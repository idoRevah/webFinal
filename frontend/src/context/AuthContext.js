...
var react_router_dom_1 = require("react-router-dom"); // ✅ Import useNavigate
...
function AuthProvider(_a) {
    ...
    var navigate = (0, react_router_dom_1.useNavigate)(); // ✅ Initialize navigation hook
    ...
    var login = function (credentials) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("http://localhost:3000/auth/google", {
                            method: "POST",
    ...
    return (<AuthContext.Provider value={{ user: user, token: token, login: login, logout: logout }}>
      {children}
