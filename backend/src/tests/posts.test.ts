...
describe('Post Routes', () => {
  ...
  it('should create a new post', async () => {
    const response = await request(app)
      ...
      .send({ title: 'Test Post', content: 'Test Content', subtitle: 'Test Subtitle', category: 'Test category'});
  ...
  it('should update a post', async () => {
    const response = await request(app)
      .put(`/posts/${postId}`)
      .set('Authorization', `Bearer ${token}`)
      .send({ title: 'Updated Title', content: 'Updated Content', subtitle: 'Updated Subtitle', category: 'Updated Category'});
